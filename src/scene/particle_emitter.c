...
int light_scene_particle_emitter_initialize(struct light_scene_state_instance *instance)
{
	
	
	uint32_t particle_emitter_buffer_size = sizeof(struct light_scene_particle_emitter_normal)*instance->build.particle_emitter_build.emitter_normal_count + 4 * sizeof(uint32_t);
	...
	uint32_t particle_lookup_buffer_size = instance->build.particle_build.emitter_count * sizeof(uint32_t);
		...
		uint32_t normal_count)
{
	...
	uint32_t lookup_index[instance->build.particle_build.emitter_count];
